...
class cumple(object):
    ...
    def iniciar(self, master):
        ...
        bgfil = PhotoImage(file = "fondo1366x768.gif")
        # bgfil = PhotoImage(file = "fondo.gif")
        # bgfil = PhotoImage(file = "fondo.png")
        ...
        self.labelpo = Label(master, textvariable=self.posi, bg="#113553", fg="#eee", width=8, justify="left", font=("Roboto", 240))
#        self.labelpo = Label(master, textvariable=self.posi, bg="#ff0000", fg="#eee", width=8, justify="left", font=("Roboto", 240))

        # DESPLIEGUE PI
        self.picustr = "3.1415"
        self.picu = StringVar()
        self.picu.set(self.picustr)
        self.labelp = Label(master, textvariable=self.picu, bg="#113553", fg="#fff", width=self.maxtext+1, justify="center", font=("Roboto", 740))

        # FECHA INGRESADA
        self.fechastr = "" # "081284","230301"
        self.fecha = StringVar()
        self.fecha.set(self.fechastr)
        self.labelf = Label(master, textvariable=self.fecha, bg="#113553", fg="#eee", width=6, justify="left", font=("Roboto", 96))

        # Resultados extras
        self.resultastr = u"Ingresa una fecha: día, mes y año"
        self.resulta = StringVar()
        self.resulta.set(self.resultastr)
        self.labelr = Label(master, textvariable=self.resulta, bg="#113553", fg="#ccc", width=50, justify="left", font=("Roboto", 45))

        # Posiciona
        # Digitos de pi
        self.labelp.place(relx=0, rely=0.52)
        # En que digito esta
        self.labelpo.place(relx=0.38, rely=.26)
        # Ingresa la fecha
        self.labelf.place(relx=0.10, rely=.3)
        # Instrucciones
        self.labelr.place(relx=0, rely=0.45)
